...
parser.add_argument(
    "--n_threads", type=int, default=20, help="number of threads for data loading"
)
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/wanbo/SRNet',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='/home/wanbo/SRNet/benchmark',
                    help='demo image directory')
parser.add_argument(
    "--data_range", type=str, default="1-800/801-810", help="train data range"
)
parser.add_argument("--ext", type=str, default="sep", help="dataset file extension")
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
# parser.add_argument('--data_test', type=str, default='DIV2K',
#                     help='expriment dataset name')
parser.add_argument('--data_test', type=str, default='Set5+Set14+B100+Urban100+Manga109',
                    help='expriment dataset name')

parser.add_argument(
    "--pre_train", type=str, default="pretrain/MFRAN-2x.pt", help="pre-trained model directory"
)
...
# MFRAN settings
parser.add_argument(
    "--FRBs", type=int, default=16, help="number of FRB blocks"
)
parser.add_argument("--path", type=int, default=4,
                    help="number of columns to use in ResFractalBlock")
parser.add_argument("--n_feats", type=int, default=64, help="number of FRB feature maps")

parser.add_argument(
    "--self_ensemble", action="store_true", help="use self-ensemble method for train",
    default="False",
)

# data test
parser.add_argument(
    "--chop", action="store_true", help="enable memory-efficient forward", default='True'
)
parser.add_argument(
    "--test_only", action="store_true", help="set this option to the model", default='True',
)
parser.add_argument("--save", type=str, default='11111', help="file name to save")
...
parser.add_argument("--model", default="MFRAN", help="model name")
...
parser.add_argument(
    ...
    default="single",
    choices=("single", "half"),
    help="FP precision for (single | half)",
)

# Training specifications
parser.add_argument("--reset", action="store_true", help="reset the training")
parser.add_argument(
    "--test_every", type=int, default=1000, help="do train per every N batches"
)
...
parser.add_argument("--save_results", action="store_true", help="save output results", default='True',)
parser.add_argument(
    "--save_gt",
    action="store_true",
